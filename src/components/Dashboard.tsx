...
import { TrendingUp, TrendingDown, DollarSign, Activity, PieChart as PieIcon, Award } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ stats, holdings, transactions }) => {
  // Chart Colors
  const COLORS = {
    Stock: '#3b82f6', // blue
    ETF: '#a855f7',   // purple
  ...
  return (
    <div className="fade-in">
      ...
      {/* Secondary row: Dividends calendar breakdown */}
